...
import com.example.sp2020_project3_a2.ListViewRestaurant.ListSelectionListener;
...
public class RestaurantActivity extends AppCompatActivity implements ListSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webFragment.setWhichActivity(1);
        ...
        ft.replace(R.id.ListFragment, new ListViewRestaurant());
    ...
    //Creating and setting actions for menu items
    @Override
    public boolean onOptionsItemSelected (MenuItem item)
    {
        switch(item.getItemId())
        {
            ...
            case R.id.attractionsItem:
                Intent intentRestaurant = new Intent(RestaurantActivity.this, AttractionsActivity.class);
